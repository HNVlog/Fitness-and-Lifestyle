    ...
    public function run()
    {
        ...
        DB::table('blogs')->insert([
            ...
            [
                ...
                'image' => 'blog-4.jpg',
                'content' => 'Practicing yoga not only helps your body to be flexible, but you also practice deep and regular breathing, making it easier for the mood to return to a balanced state. To practice yoga most effectively, of course you should join reputable classes. If you are too busy, you can do the following basic yoga movements on your own every morning to start the day full of energy!',
                'content_2' => 'The spine is the root of the whole body. A healthy spine helps the organs in the body to function smoothly. The Bow Pose will help activate the spinal nerves, making this "pillar" stronger and stronger. At the same time, this movement also helps you strengthen the tone of the lower abs, open the chest, open the shoulders and neck, stretch the thighs and arms.',
                'category' => 'Live',
                'image_1' => 'blogdetail6-1.jpg',
                'image_2' => 'blogdetail6-2.jpg',
            ],
            [
                'id' => 5,
                'user_id' => 3,
                ...
                'image' => 'blog-5.jpg',
                'content' => 'Yoga is known as a zen exercise for a reason. There are actually quite a few reasons why yoga is helpful for relaxation and stress. Two of the main factors? Stretching your body helps relieve physical tension, which many people also say helps them feel less mentally or emotional tense. Secondly, an important part of yoga is connecting to your breathing and learning how to breathe deeper and in sync with movement.',
                'content_2' => 'Yoga instructor and certified health coach Meredith Wadsworth says that another reason why yoga and stretching can help relieve stress is because you break the cycle of worrying or focusing on what is going on in your life to focus on your body.',
                'category' => 'Weight',
                'image_1' => 'blogdetail5-1.jpg',
                'image_2' => 'blogdetail5-2.jpg',
            ],
            [
                'id' => 6,
                'user_id' => 3,
                ...
                'image' => 'blog-6.jpg',
                'content' => 'If you feel like starting yoga, just do it. Even from home, alone, with your mat. You don not need more. “There is no good or bad time to start doing yoga,” experts tell us. Because you have limited space and yoga gives you many physical benefits. as well as mentally and emotionally".',
                'content_2' => 'Once you have completed this circuit of 20 easy poses, you can gradually move on to other levels. Don not despair if you find that they don not suit you, that you don not have enough flexibility or that you lose your balance easily. In yoga, you never have to force. So do the best you can, relax yourself and don not pressurize.',
                'category' => 'Beauty',
                'image_1' => 'blogdetail4-1.jpg',
                'image_2' => 'blogdetail4-2.jpg',
            ],
            [
                'id' => 7,
                'user_id' => 3,
                ...
                'content' => 'Did you know that what you eat after a workout for recovery is just as important as what you eat before a workout for fuel? Believe it or not, eating the right types of recovery foods can actually help you grow stronger as an athlete.
                ...
                'content_2' => 'Besides the physiological components of recovery, it’s also important to think about hunger and appetite. If you don’t eat after a workout, you’ll probably feel very hungry later on in the day. This can cause you to overeat foods that aren’t all the nutritious and don’t help with recovery.',
                'category' => 'Healthy Food',
                'image_1' => 'blogdetail3-1.jpg',
                'image_2' => 'blogdetail3-2.jpg',
            ],
            [
                'id' => 8,
                'user_id' => 3,
                ...
                'content_2' => 'Remember that the length and intensity of your activity will determine how often and what you should eat and drink. For example, you will need more energy from food to run a marathon than to walk a few kilometers. Try not to include any new products in your diet before an extended sporting event. It is best to have previous experience listening to your body process food.',
                'category' => 'Healthy Food',
                'image_1' => 'blogdetail2-1.jpg',
                'image_2' => 'blogdetail2-2.jpg',
            ],
            [
                'id' => 9,
                'user_id' => 3,
                ...
                'image' => 'healthy-3.jpg',
                'content' => 'The General Motor Diet is a fast weight loss diet that is safe for people to perform, originating in the United States. This diet has been tested by scientists and received very desirable results. GM diet works on the principle of providing less calories for the body, promoting energy metabolism, thereby losing weight quickly. With this weight loss diet, you use foods such as vegetables and fruits mainly. Combine with different cooking methods to create delicious dishes without feeling bored. Stick with the weight loss menu for 7 days and you will definitely succeed.',
                'content_2' => 'Besides the diet to lose weight, science has proven that exercise is a good and healthy weight loss measure. If you intend to lose weight quickly and safely, you should refer to home exercise equipment such as Elipsport or exercise bikes at Elipsport, you will experience modern equipment lines, care services. Best customer care. You no longer have to worry about losing weight.',
                'category' => 'Fruit',
                'image_1' => 'blogdetail1-1.jpg',
                'image_2' => 'blogdetail1-2.jpg',
            ],
        ]);
