...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/ad">
            ...
            <div class="sidebar-brand-text mx-3">HNVlog</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="/ad/account">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    <h6><strong>{{ \Illuminate\Support\Facades\Auth::user()->name }}</strong></h6>
                </span>
                            <img class="img-profile rounded-circle"
                                 src={{url('front/img/user/'.\Illuminate\Support\Facades\Auth::user()->avatar)}}>
                        </a>
                        <!-- Dropdown - User Information -->
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                             aria-labelledby="userDropdown">

                            <a class="dropdown-item" href="/ad/logout" data-target="#logoutModal">
            ...
            <div CLASS="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Classes</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$classes->count()}} classes</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Blog </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$blog->count()}} posts</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Comment</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$cmt->count()}} comment new</div>
                                        </div>
                                        <div class="col-auto">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 mb-4">
                        ...
                        <div class="card shadow mb-4" style="height: 414.4px;">
                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <h4 class="small font-weight-bold">Order<span
                                            class="float-right">{{round(count($order1)/count($orders)*100,2) }}%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: {{count($order1)/count($orders)*100}}%"
                                             aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                @endif

                                @if(count($support)==0)
                                    <h4 class="small font-weight-bold">Support<span
                                            class="float-right">0%</span></h4>
                                    <div class="progress mb-4">
                                ...
                                @else
                                    <h4 class="small font-weight-bold">Support<span
                                            class="float-right">{{round(count($sup1)/count($support)*100,2)}}%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: {{count($sup1)/count($support)*100}}%"
                                             aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                @endif

                                @if(count($comment)==0)
                                    <h4 class="small font-weight-bold">Comment<span
                                            class="float-right">0%</span></h4>
                                    <div class="progress mb-4">
                                ...
                                @else
                                    <h4 class="small font-weight-bold">Comment<span
                                            class="float-right">{{round(100-count($cmt)/count($comment)*100,2)}}%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: {{100-count($cmt)/count($comment)*100}}%"
                                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                @endif

                                    <h4 class="small font-weight-bold">Account<span
                                    ...
                                    @if(count($orders)==0&&count($support)!=0&&count($comment)!=0)
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-success" role="progressbar" style="width: {{(count($sup1)/count($support)*100+100-count($cmt)/count($comment)*100+100)/4}}%"
                                                 aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    @elseif(count($orders)!=0&&count($support)==0&&count($comment)!=0)
                                        <h4 class="small font-weight-bold">Progress <span
                                                class="float-right">{{round((count($order1)/count($orders)*100+100-count($cmt)/count($comment)*100+100)/4,2)}}%</span></h4>
                                        <div class="progress">
                                            <div class="progress-bar bg-success" role="progressbar" style="width: {{(count($order1)/count($orders)*100+100-count($cmt)/count($comment)*100+100)/4}}%"
                                                 aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    @elseif(count($orders)!=0&&count($support)!=0&&count($comment)==0)
                                        <h4 class="small font-weight-bold">Progress <span
                                                class="float-right">{{round((count($order1)/count($orders)*100+count($sup1)/count($support)*100+100)/4,2)}}%</span></h4>
                                        <div class="progress">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; HNVlog</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
