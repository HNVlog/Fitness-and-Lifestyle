            ...
            <div class="row">
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="services__item">
                        <img src="front/img/services/xservices-1.png.pagespeed.ic.wcgYMsTLjc.png" alt="">
                        <h5>Asana</h5>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-1.jpg.pagespeed.ic.24p3KMv4Wq.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-2.jpg.pagespeed.ic.9OtlJN_hUV.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-3.jpg.pagespeed.ic.GrRy1ivn-D.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-4.jpg.pagespeed.ic.nFY6_W2ekv.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-5.jpg.pagespeed.ic.1WoQd-xlts.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-6.jpg.pagespeed.ic.czwBkFmnyf.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-7.jpg.pagespeed.ic.n4nQBWiuEs.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-6 p-0">
                <div class="gallery__pic">
                    <img src="front/img/gallery/xgallery-8.jpg.pagespeed.ic.39rtZHKAZA.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="instructor__item">
                    <div class="instructor__item__pic">
                        <img src="front/img/instructor/xinstructor-1.jpg.pagespeed.ic.FBQBp6FP2b.jpg" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="instructor__item">
                    <div class="instructor__item__pic">
                        <img src="front/img/instructor/xinstructor-2.jpg.pagespeed.ic.Plmkl5KL9f.jpg" alt="">
                    </div>
                    <div class="instructor__item__text">
                        <h5>Rebecca James</h5>
                        <span>Yoga Trainer</span>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="instructor__item">
                    <div class="instructor__item__pic">
                        <img src="front/img/instructor/xinstructor-3.jpg.pagespeed.ic.Bu5LJR0iK0.jpg" alt="">
                    </div>
                    <div class="instructor__item__text">
                        <h5>Melissa Smith</h5>
                        <span>Yoga Trainer</span>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="instructor__item">
                    <div class="instructor__item__pic">
                        <img src="front/img/instructor/xinstructor-4.jpg.pagespeed.ic.vcYYmzBEDa.jpg" alt="">
                    </div>
                    <div class="instructor__item__text">
                        <h5>Emily Walker</h5>
                        <span>Yoga Trainer</span>
